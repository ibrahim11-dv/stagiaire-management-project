...
<head>
    ...
    <title>Gestion des Encadrants - Plateforme Stagiaires</title>
        ...
        <div class="row">
            ...
            <div class="col-md-10 main-content p-4">
                ...
                <div class="d-flex justify-content-between mb-4">
                    <button class="btn btn-add" onclick="window.location.href='encadrants_add.php'">
                    ...
                    <div class="col-md-5">
                        <form method="get" action="<?= $_SERVER['PHP_SELF'] ?>" class="input-group">
                            <select class="form-select search-select" name="search_by" id="search_by">
                                ...
                                <option value="poste" <?= isset($_GET['search_by']) && $_GET['search_by'] == 'poste' ? 'selected' : '' ?>>Poste</option>
                            ...
                            <select class="form-select search-input d-none" id="status_search" name="search_status">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM encadrant WHERE est_supp = false";
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                ...
                                <?php
                                $sql_p = 'SELECT COUNT(*) AS total FROM encadrant WHERE est_supp = false';
                                ...
                                $encadrant_nmb = mysqli_fetch_assoc($result_p);
                                $total_pages = ceil($encadrant_nmb['total'] / $items_per_page);
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body py-4">
                    ...
                    <h6 class="text-center mb-3 fw-bold">Êtes-vous sûr de vouloir supprimer cet encadrant ?</h6>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-outline-info.action-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    window.location.href = 'encadrants_details.php?id=' + id;
                });
            });
            ...
            document.querySelectorAll('.btn-outline-danger.action-btn').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    e.preventDefault();
                    encadrantIdToDelete = this.closest('td.actions').getAttribute('data-id');
                    deleteModal.show();
                });
            });
            ...
            document.getElementById('confirmDelete').addEventListener('click', function() {
                if (encadrantIdToDelete) {
                    window.location.href = 'encadrants_delete.php?id=' + encadrantIdToDelete + '&page=' + <?= $current_page ?>;
                }
            });
            ...
            searchBy.addEventListener('change', updateSearchFields);
        });
    </script>
</body>
</html>